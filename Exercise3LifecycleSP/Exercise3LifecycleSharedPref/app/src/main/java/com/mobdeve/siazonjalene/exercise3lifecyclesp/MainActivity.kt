...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val savedLayoutType = sharedPreference.getInt("layoutType", LayoutType.LINEAR_VIEW_TYPE.ordinal)
        val hideLikeButtons = sharedPreference.getBoolean("hideLikeButtons", false)
